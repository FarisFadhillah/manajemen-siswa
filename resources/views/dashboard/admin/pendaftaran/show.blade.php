    ...
    <section class="section">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <table class="table table-striped" id="table1">
                    <tr>
                        <td>Asal Sekolah</td> <td>:</td> <td>{{ $tambahan->asal_sekolah }}</td>
                        <td>Nomor Induk Siswa</td> <td>:</td> <td>{{ $tambahan->nis }}</td>
                    </tr>
                    <tr>
                        <td>Nomor Peserta</td> <td>:</td> <td>{{ $tambahan->nomor_peserta }}</td>
                        <td>Nomor Ijazah</td> <td>:</td> <td>{{ $tambahan->nomor_ijasah }}</td>
                    </tr>
                    <tr>
                        <td>Hobby</td> <td>:</td> <td>{{ $tambahan->hobi }}</td>
                        <td>Cita-cita</td> <td>:</td> <td>{{ $tambahan->cita_cita }}</td>
                    </tr>
                    <tr>
                        <td>Ijazah</td> <td>:</td> <td><img src="{{ asset('storage/images/dokumenPendaftaran/' . $tambahan->doc_ijasah) }}"  style="max-width: 100%; max-height: 200px;">
                        </td>
                        <td>Akta Kelahiran</td> <td>:</td> <td><img src="{{ asset('storage/images/dokumenPendaftaran/' . $tambahan->doc_akte) }}"  style="max-width: 100%; max-height: 200px;">
                        </td>
                    </tr>
                    <tr>
                        <td>Kartu Keluarga</td> <td>:</td> <td><img src="{{ asset('storage/images/dokumenPendaftaran/' . $tambahan->doc_kk) }}"  style="max-width: 100%; max-height: 200px;">
                        </td>
                        <td>KTP Orang Tua</td> <td>:</td> <td><img src="{{ asset('storage/images/dokumenPendaftaran/' . $tambahan->doc_ktp) }}"  style="max-width: 100%; max-height: 200px;">
                        </td>
                    </tr>
                    <tr>
                        <td>KIP</td> <td>:</td> <td><img src="{{ asset('storage/images/dokumenPendaftaran/' . $tambahan->doc_kip) }}"  style="max-width: 100%; max-height: 200px;">
                        </td>
                        <td></td> <td></td> <td></td>
                    </tr>
                </table>
